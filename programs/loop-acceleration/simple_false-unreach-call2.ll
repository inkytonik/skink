...
; <label>:9                                       ; preds = %3
  ...
  %11 = icmp ugt i32 %10, 268435455, !dbg !37
  %12 = zext i1 %11 to i32, !dbg !37
  %13 = bitcast i32* %1 to i8*, !dbg !38
  call void @llvm.lifetime.start(i64 4, i8* %13), !dbg !38
  store i32 %12, i32* %1, align 4, !dbg !38
  %14 = load i32, i32* %1, align 4, !dbg !39
  %15 = icmp ne i32 %14, 0, !dbg !40
  br i1 %15, label %__VERIFIER_assert.exit, label %16, !dbg !41
...
__VERIFIER_assert.exit:                           ; preds = %9
  %17 = bitcast i32* %1 to i8*, !dbg !43
  call void @llvm.lifetime.end(i64 4, i8* %17), !dbg !43
  %18 = load i32, i32* %2, !dbg !44
  ret i32 %18, !dbg !44
}
...
!1 = !DIFile(filename: "../../../sv-comp-2016/c/loop-acceleration/simple_false-unreach-call2.i", directory: "/Users/franck/development/perentiemq/programs/svcomp16")
!2 = !{}
!3 = !{!4, !8}
...
!35 = distinct !DILexicalBlock(scope: !8, file: !1, line: 10, column: 26)
!36 = !DILocation(line: 13, column: 21, scope: !8)
!37 = !DILocation(line: 13, column: 23, scope: !8)
!38 = !DILocation(line: 13, column: 3, scope: !8)
!39 = !DILocation(line: 3, column: 9, scope: !19, inlinedAt: !30)
!40 = !DILocation(line: 3, column: 8, scope: !19, inlinedAt: !30)
!41 = !DILocation(line: 3, column: 7, scope: !4, inlinedAt: !30)
!42 = !DILocation(line: 4, column: 12, scope: !24, inlinedAt: !30)
!43 = !DILocation(line: 6, column: 3, scope: !4, inlinedAt: !30)
!44 = !DILocation(line: 14, column: 1, scope: !8)
