...
define i32 @main() #0 {
  ...
  store i32 %4, i32* %y, align 4, !dbg !31
  call void @llvm.dbg.declare(metadata i32* %1, metadata !15, metadata !16), !dbg !33
  br label %5, !dbg !35

; <label>:5                                       ; preds = %8, %0
  %6 = load i32, i32* %x, align 4, !dbg !36
  %7 = icmp ult i32 %6, 1024, !dbg !37
  br i1 %7, label %8, label %13, !dbg !35

; <label>:8                                       ; preds = %5
  %9 = load i32, i32* %x, align 4, !dbg !38
  %10 = add i32 %9, 1, !dbg !38
  store i32 %10, i32* %x, align 4, !dbg !38
  %11 = load i32, i32* %y, align 4, !dbg !40
  %12 = add i32 %11, 1, !dbg !40
  store i32 %12, i32* %y, align 4, !dbg !40
  br label %5, !dbg !35

; <label>:13                                      ; preds = %5
  %14 = load i32, i32* %x, align 4, !dbg !41
  %15 = load i32, i32* %y, align 4, !dbg !42
  %16 = icmp eq i32 %14, %15, !dbg !43
  %17 = zext i1 %16 to i32, !dbg !43
  %18 = bitcast i32* %1 to i8*, !dbg !44
  call void @llvm.lifetime.start(i64 4, i8* %18), !dbg !44
  store i32 %17, i32* %1, align 4, !dbg !44
  %19 = load i32, i32* %1, align 4, !dbg !45
  %20 = icmp ne i32 %19, 0, !dbg !46
  br i1 %20, label %__VERIFIER_assert.exit, label %21, !dbg !47
...
__VERIFIER_assert.exit:                           ; preds = %13
  ...
  call void @llvm.lifetime.end(i64 4, i8* %22), !dbg !49
  %23 = load i32, i32* %2, !dbg !50
  ret i32 %23, !dbg !50
}
...
!1 = !DIFile(filename: "../../../sv-comp-2016/c/loop-acceleration/multivar_true-unreach-call1.i", directory: "/Users/franck/development/perentiemq/programs/svcomp16")
!2 = !{}
!3 = !{!4, !8}
...
!34 = distinct !DILocation(line: 16, column: 3, scope: !8)
!35 = !DILocation(line: 12, column: 3, scope: !8)
!36 = !DILocation(line: 12, column: 10, scope: !8)
!37 = !DILocation(line: 12, column: 12, scope: !8)
!38 = !DILocation(line: 13, column: 6, scope: !39)
!39 = distinct !DILexicalBlock(scope: !8, file: !1, line: 12, column: 20)
!40 = !DILocation(line: 14, column: 6, scope: !39)
!41 = !DILocation(line: 16, column: 21, scope: !8)
!42 = !DILocation(line: 16, column: 26, scope: !8)
!43 = !DILocation(line: 16, column: 23, scope: !8)
...
!50 = !DILocation(line: 17, column: 1, scope: !8)
