...
; <label>:13                                      ; preds = %4
  ...
  %16 = bitcast i32* %1 to i8*, !dbg !53
  call void @llvm.lifetime.start(i64 4, i8* %16), !dbg !53
  store i32 %15, i32* %1, align 4, !dbg !53
  %17 = load i32, i32* %1, align 4, !dbg !54
  %18 = icmp ne i32 %17, 0, !dbg !55
  br i1 %18, label %__VERIFIER_assert.exit, label %19, !dbg !56

; <label>:19                                      ; preds = %13
  call void (...) @__VERIFIER_error() #5, !dbg !57
  unreachable, !dbg !57

__VERIFIER_assert.exit:                           ; preds = %13
  %20 = bitcast i32* %1 to i8*, !dbg !58
  call void @llvm.lifetime.end(i64 4, i8* %20), !dbg !58
  %21 = load i32, i32* %3, !dbg !59
  ret i32 %21, !dbg !59
}
...
!1 = !DIFile(filename: "../../../sv-comp-2016/c/loop-acceleration/functions_false-unreach-call1.i", directory: "/Users/franck/development/perentiemq/programs/svcomp16")
!2 = !{}
!3 = !{!4, !8, !12}
...
!51 = !DILocation(line: 16, column: 21, scope: !12)
!52 = !DILocation(line: 16, column: 23, scope: !12)
!53 = !DILocation(line: 16, column: 3, scope: !12)
!54 = !DILocation(line: 3, column: 9, scope: !23, inlinedAt: !41)
!55 = !DILocation(line: 3, column: 8, scope: !23, inlinedAt: !41)
!56 = !DILocation(line: 3, column: 7, scope: !4, inlinedAt: !41)
!57 = !DILocation(line: 4, column: 12, scope: !28, inlinedAt: !41)
!58 = !DILocation(line: 6, column: 3, scope: !4, inlinedAt: !41)
!59 = !DILocation(line: 17, column: 1, scope: !12)
