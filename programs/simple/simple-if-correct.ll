...
; <label>:5                                       ; preds = %0
  ...
  %8 = icmp sgt i32 %6, %7, !dbg !25
  %9 = zext i1 %8 to i32, !dbg !25
  %10 = call i32 (i32, ...) bitcast (i32 (...)* @__VERIFIER_assert to i32 (i32, ...)*)(i32 %9), !dbg !26
  br label %11, !dbg !26

; <label>:11                                      ; preds = %5, %0
  %12 = load i32, i32* %i, align 4, !dbg !27
  %13 = load i32, i32* %j, align 4, !dbg !29
  %14 = icmp sgt i32 %12, %13, !dbg !30
  br i1 %14, label %15, label %21, !dbg !31

; <label>:15                                      ; preds = %11
  %16 = load i32, i32* %i, align 4, !dbg !32
  %17 = load i32, i32* %j, align 4, !dbg !33
  %18 = icmp sgt i32 %16, %17, !dbg !34
  %19 = zext i1 %18 to i32, !dbg !34
  %20 = call i32 (i32, ...) bitcast (i32 (...)* @__VERIFIER_assert to i32 (i32, ...)*)(i32 %19), !dbg !35
  br label %21, !dbg !35

; <label>:21                                      ; preds = %15, %11
  %22 = load i32, i32* %1, !dbg !36
  ret i32 %22, !dbg !36
}
...
!1 = !DIFile(filename: "simple-if-correct.c", directory: "/Users/asloane/Projects/PerentieMQ/perentiemq/programs/simple")
!2 = !{}
!3 = !{!4}
...
!5 = !DIFile(filename: "simple-if-correct.c", directory: "/Users/asloane/Projects/PerentieMQ/perentiemq/programs/simple")
...
!24 = !DILocation(line: 5, column: 29, scope: !19)
!25 = !DILocation(line: 5, column: 27, scope: !19)
!26 = !DILocation(line: 5, column: 6, scope: !19)
!27 = !DILocation(line: 6, column: 8, scope: !28)
!28 = distinct !DILexicalBlock(scope: !4, file: !5, line: 6, column: 8)
!29 = !DILocation(line: 6, column: 12, scope: !28)
!30 = !DILocation(line: 6, column: 10, scope: !28)
!31 = !DILocation(line: 6, column: 8, scope: !4)
!32 = !DILocation(line: 7, column: 25, scope: !28)
!33 = !DILocation(line: 7, column: 29, scope: !28)
!34 = !DILocation(line: 7, column: 27, scope: !28)
!35 = !DILocation(line: 7, column: 6, scope: !28)
!36 = !DILocation(line: 8, column: 1, scope: !4)
