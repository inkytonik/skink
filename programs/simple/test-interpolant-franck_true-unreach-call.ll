...
define i32 @main() #0 {
  ...
  store i32 10, i32* %x, align 4, !dbg !28
...
; <label>:11                                      ; preds = %3
  ...
  %13 = icmp eq i32 %12, 10, !dbg !40
  %14 = zext i1 %13 to i32, !dbg !40
  %15 = bitcast i32* %1 to i8*, !dbg !41
  call void @llvm.lifetime.start(i64 4, i8* %15), !dbg !41
  store i32 %14, i32* %1, align 4, !dbg !41
  %16 = load i32, i32* %1, align 4, !dbg !42
  %17 = icmp ne i32 %16, 0, !dbg !43
  br i1 %17, label %__VERIFIER_assert.exit, label %18, !dbg !44
...
__VERIFIER_assert.exit:                           ; preds = %11
  ...
  call void @llvm.lifetime.end(i64 4, i8* %19), !dbg !46
  %20 = load i32, i32* %2, !dbg !47
  ret i32 %20, !dbg !47
}
...
!1 = !DIFile(filename: "test-interpolant-franck_true-unreach-call.c", directory: "/Users/asloane/Projects/PerentieMQ/perentiemq/programs/simple")
!2 = !{}
!3 = !{!4, !8}
...
!26 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "x", scope: !8, file: !1, line: 13, type: !27)
!27 = !DIBasicType(name: "unsigned int", size: 32, align: 32, encoding: DW_ATE_unsigned)
!28 = !DILocation(line: 13, column: 16, scope: !8)
!29 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "y", scope: !8, file: !1, line: 13, type: !27)
!30 = !DILocation(line: 13, column: 22, scope: !8)
!31 = !DILocation(line: 3, column: 28, scope: !4, inlinedAt: !32)
!32 = distinct !DILocation(line: 19, column: 3, scope: !8)
!33 = !DILocation(line: 14, column: 3, scope: !8)
!34 = !DILocation(line: 14, column: 9, scope: !8)
!35 = !DILocation(line: 14, column: 10, scope: !8)
!36 = !DILocation(line: 16, column: 6, scope: !37)
!37 = distinct !DILexicalBlock(scope: !8, file: !1, line: 15, column: 3)
!38 = !DILocation(line: 17, column: 6, scope: !37)
!39 = !DILocation(line: 19, column: 21, scope: !8)
!40 = !DILocation(line: 19, column: 22, scope: !8)
...
!45 = !DILocation(line: 5, column: 12, scope: !24, inlinedAt: !32)
!46 = !DILocation(line: 7, column: 3, scope: !4, inlinedAt: !32)
!47 = !DILocation(line: 20, column: 1, scope: !8)
