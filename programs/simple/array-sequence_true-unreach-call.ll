...
define i32 @main() #0 {
  ...
  call void @llvm.dbg.declare(metadata [2 x i32]* %A, metadata !26, metadata !15), !dbg !30
...
__VERIFIER_assert.exit:                           ; preds = %0
  ...
  call void @llvm.dbg.declare(metadata i32* %1, metadata !14, metadata !15), !dbg !46
  ret i32 0, !dbg !47
}
...
!1 = !DIFile(filename: "../programs/simple/array-sequence_true-unreach-call.c", directory: "/vagrant/skink")
!2 = !{}
!3 = !{!4, !8}
...
!40 = !DILocation(line: 4, column: 9, scope: !18, inlinedAt: !41)
!41 = distinct !DILocation(line: 16, column: 3, scope: !8)
!42 = !DILocation(line: 4, column: 8, scope: !18, inlinedAt: !41)
