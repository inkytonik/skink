...
; <label>:9                                       ; preds = %3
  ...
  call void @llvm.lifetime.start(i64 4, i8* %12), !dbg !38
  store i32 %11, i32* %1, align 4, !dbg !38
  %13 = load i32, i32* %1, align 4, !dbg !39
  %14 = icmp ne i32 %13, 0, !dbg !40
  br i1 %14, label %__VERIFIER_assert.exit, label %15, !dbg !41
...
__VERIFIER_assert.exit:                           ; preds = %9
  ...
  call void @llvm.lifetime.end(i64 4, i8* %16), !dbg !43
  %17 = load i32, i32* %2, !dbg !44
  ret i32 %17, !dbg !44
}
...
!1 = !DIFile(filename: "../../../sv-comp-2016/c/loop-acceleration/simple_false-unreach-call1.i", directory: "/Users/franck/development/perentiemq/programs/svcomp16")
!2 = !{}
!3 = !{!4, !8}
