...
; <label>:11                                      ; preds = %3
  ...
  %15 = xor i1 %14, true, !dbg !42
  %16 = zext i1 %15 to i32, !dbg !42
  %17 = bitcast i32* %1 to i8*, !dbg !43
  call void @llvm.lifetime.start(i64 4, i8* %17), !dbg !43
  store i32 %16, i32* %1, align 4, !dbg !43
  %18 = load i32, i32* %1, align 4, !dbg !44
  %19 = icmp ne i32 %18, 0, !dbg !45
  br i1 %19, label %__VERIFIER_assert.exit, label %20, !dbg !46
...
__VERIFIER_assert.exit:                           ; preds = %11
  %21 = bitcast i32* %1 to i8*, !dbg !48
  call void @llvm.lifetime.end(i64 4, i8* %21), !dbg !48
  %22 = load i32, i32* %2, !dbg !49
  ret i32 %22, !dbg !49
}
...
!1 = !DIFile(filename: "../../../sv-comp-2016/c/loop-acceleration/simple_true-unreach-call3.i", directory: "/Users/franck/development/perentiemq/programs/svcomp16")
!2 = !{}
!3 = !{!4, !8}
...
!41 = !DILocation(line: 14, column: 25, scope: !8)
!42 = !DILocation(line: 14, column: 21, scope: !8)
!43 = !DILocation(line: 14, column: 3, scope: !8)
!44 = !DILocation(line: 3, column: 9, scope: !19, inlinedAt: !33)
!45 = !DILocation(line: 3, column: 8, scope: !19, inlinedAt: !33)
!46 = !DILocation(line: 3, column: 7, scope: !4, inlinedAt: !33)
!47 = !DILocation(line: 4, column: 12, scope: !24, inlinedAt: !33)
!48 = !DILocation(line: 6, column: 3, scope: !4, inlinedAt: !33)
!49 = !DILocation(line: 15, column: 1, scope: !8)
