...
; <label>:2306                                    ; preds = %2305
  call void @__VERIFIER_error(), !dbg !2655
  br label %2307, !dbg !2657

; <label>:2307                                    ; preds = %2306, %2302, %2299, %2296, %2293, %2290, %2287, %2284
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label15_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2657 = !DILocation(line: 420, column: 6, scope: !2656)
