...
; <label>:2881                                    ; preds = %2880
  call void @__VERIFIER_error(), !dbg !3280
  br label %2882, !dbg !3282

; <label>:2882                                    ; preds = %2881, %2877, %2874, %2871, %2868, %2865, %2862, %2859
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label51_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3282 = !DILocation(line: 495, column: 6, scope: !3281)
