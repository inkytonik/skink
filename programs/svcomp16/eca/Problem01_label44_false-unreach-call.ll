...
; <label>:2375                                    ; preds = %2374
  call void @__VERIFIER_error(), !dbg !2730
  br label %2376, !dbg !2732

; <label>:2376                                    ; preds = %2375, %2371, %2368, %2365, %2362, %2359, %2356, %2353
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label44_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2732 = !DILocation(line: 429, column: 6, scope: !2731)
