...
; <label>:2704                                    ; preds = %2703
  call void @__VERIFIER_error(), !dbg !3102
  br label %2705, !dbg !3104

; <label>:2705                                    ; preds = %2704, %2700, %2697, %2694, %2691, %2688, %2685
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label01_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3104 = !DILocation(line: 512, column: 6, scope: !3103)
