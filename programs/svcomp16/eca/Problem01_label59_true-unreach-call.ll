...
; <label>:2490                                    ; preds = %2489
  call void @__VERIFIER_error(), !dbg !2855
  br label %2491, !dbg !2857

; <label>:2491                                    ; preds = %2490, %2486, %2483, %2480, %2477, %2474, %2471, %2468
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label59_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2857 = !DILocation(line: 444, column: 6, scope: !2856)
