...
; <label>:2724                                    ; preds = %2723
  call void @__VERIFIER_error(), !dbg !3124
  br label %2725, !dbg !3126

; <label>:2725                                    ; preds = %2724, %2720, %2717, %2714, %2711, %2708, %2705
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label24_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3126 = !DILocation(line: 515, column: 6, scope: !3125)
