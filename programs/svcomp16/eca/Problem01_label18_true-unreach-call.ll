...
; <label>:2743                                    ; preds = %2742
  call void @__VERIFIER_error(), !dbg !3130
  br label %2744, !dbg !3132

; <label>:2744                                    ; preds = %2743, %2739, %2736, %2733, %2730, %2727, %2724, %2721
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label18_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3132 = !DILocation(line: 477, column: 6, scope: !3131)
