...
; <label>:2084                                    ; preds = %2083
  call void @__VERIFIER_error(), !dbg !2420
  br label %2085, !dbg !2422

; <label>:2085                                    ; preds = %2084, %2080, %2077, %2074, %2071, %2068, %2065
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label45_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2422 = !DILocation(line: 419, column: 6, scope: !2421)
