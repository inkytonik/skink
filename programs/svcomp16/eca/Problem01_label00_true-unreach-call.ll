...
; <label>:2927                                    ; preds = %2926
  call void @__VERIFIER_error(), !dbg !3330
  br label %2928, !dbg !3332

; <label>:2928                                    ; preds = %2927, %2923, %2920, %2917, %2914, %2911, %2908, %2905
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label00_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3332 = !DILocation(line: 501, column: 6, scope: !3331)
