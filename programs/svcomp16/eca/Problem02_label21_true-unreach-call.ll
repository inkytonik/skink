...
; <label>:2364                                    ; preds = %2363
  call void @__VERIFIER_error(), !dbg !2728
  br label %2365, !dbg !2730

; <label>:2365                                    ; preds = %2364, %2360, %2357, %2354, %2351, %2348, %2345
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label21_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2730 = !DILocation(line: 461, column: 6, scope: !2729)
