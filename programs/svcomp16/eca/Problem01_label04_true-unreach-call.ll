...
; <label>:2651                                    ; preds = %2650
  call void @__VERIFIER_error(), !dbg !3030
  br label %2652, !dbg !3032

; <label>:2652                                    ; preds = %2651, %2647, %2644, %2641, %2638, %2635, %2632, %2629
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label04_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3032 = !DILocation(line: 465, column: 6, scope: !3031)
