...
; <label>:2122                                    ; preds = %2121
  call void @__VERIFIER_error(), !dbg !2455
  br label %2123, !dbg !2457

; <label>:2123                                    ; preds = %2122, %2118, %2115, %2112, %2109, %2106, %2103, %2100
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label47_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2457 = !DILocation(line: 396, column: 6, scope: !2456)
