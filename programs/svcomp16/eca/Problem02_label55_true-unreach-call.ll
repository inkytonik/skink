...
; <label>:2544                                    ; preds = %2543
  call void @__VERIFIER_error(), !dbg !2926
  br label %2545, !dbg !2928

; <label>:2545                                    ; preds = %2544, %2540, %2537, %2534, %2531, %2528, %2525
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label55_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2928 = !DILocation(line: 488, column: 6, scope: !2927)
