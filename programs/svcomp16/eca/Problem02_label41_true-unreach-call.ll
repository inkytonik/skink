...
; <label>:2244                                    ; preds = %2243
  call void @__VERIFIER_error(), !dbg !2596
  br label %2245, !dbg !2598

; <label>:2245                                    ; preds = %2244, %2240, %2237, %2234, %2231, %2228, %2225
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label41_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2598 = !DILocation(line: 443, column: 6, scope: !2597)
