...
; <label>:2904                                    ; preds = %2903
  call void @__VERIFIER_error(), !dbg !3305
  br label %2905, !dbg !3307

; <label>:2905                                    ; preds = %2904, %2900, %2897, %2894, %2891, %2888, %2885, %2882
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label49_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3307 = !DILocation(line: 498, column: 6, scope: !3306)
