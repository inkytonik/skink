...
; <label>:2224                                    ; preds = %2223
  call void @__VERIFIER_error(), !dbg !2574
  br label %2225, !dbg !2576

; <label>:2225                                    ; preds = %2224, %2220, %2217, %2214, %2211, %2208, %2205
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label40_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2576 = !DILocation(line: 440, column: 6, scope: !2575)
