...
; <label>:3249                                    ; preds = %3248
  call void @__VERIFIER_error(), !dbg !3680
  br label %3250, !dbg !3682

; <label>:3250                                    ; preds = %3249, %3245, %3242, %3239, %3236, %3233, %3230, %3227
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label54_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3682 = !DILocation(line: 543, column: 6, scope: !3681)
