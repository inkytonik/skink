...
; <label>:2304                                    ; preds = %2303
  call void @__VERIFIER_error(), !dbg !2662
  br label %2305, !dbg !2664

; <label>:2305                                    ; preds = %2304, %2300, %2297, %2294, %2291, %2288, %2285
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label02_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2664 = !DILocation(line: 452, column: 6, scope: !2663)
