...
; <label>:2564                                    ; preds = %2563
  call void @__VERIFIER_error(), !dbg !2948
  br label %2565, !dbg !2950

; <label>:2565                                    ; preds = %2564, %2560, %2557, %2554, %2551, %2548, %2545
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label04_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2950 = !DILocation(line: 491, column: 6, scope: !2949)
