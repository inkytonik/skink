...
; <label>:2421                                    ; preds = %2420
  call void @__VERIFIER_error(), !dbg !2780
  br label %2422, !dbg !2782

; <label>:2422                                    ; preds = %2421, %2417, %2414, %2411, %2408, %2405, %2402, %2399
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label19_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2782 = !DILocation(line: 435, column: 6, scope: !2781)
