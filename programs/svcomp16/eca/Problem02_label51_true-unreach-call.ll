...
; <label>:2644                                    ; preds = %2643
  call void @__VERIFIER_error(), !dbg !3036
  br label %2645, !dbg !3038

; <label>:2645                                    ; preds = %2644, %2640, %2637, %2634, %2631, %2628, %2625
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label51_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3038 = !DILocation(line: 503, column: 6, scope: !3037)
