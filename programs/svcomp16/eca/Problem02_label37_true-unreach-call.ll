...
; <label>:2844                                    ; preds = %2843
  call void @__VERIFIER_error(), !dbg !3256
  br label %2845, !dbg !3258

; <label>:2845                                    ; preds = %2844, %2840, %2837, %2834, %2831, %2828, %2825
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label37_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3258 = !DILocation(line: 533, column: 6, scope: !3257)
