...
; <label>:2264                                    ; preds = %2263
  call void @__VERIFIER_error(), !dbg !2618
  br label %2265, !dbg !2620

; <label>:2265                                    ; preds = %2264, %2260, %2257, %2254, %2251, %2248, %2245
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label57_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2620 = !DILocation(line: 446, column: 6, scope: !2619)
