...
; <label>:2513                                    ; preds = %2512
  call void @__VERIFIER_error(), !dbg !2880
  br label %2514, !dbg !2882

; <label>:2514                                    ; preds = %2513, %2509, %2506, %2503, %2500, %2497, %2494, %2491
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label02_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2882 = !DILocation(line: 447, column: 6, scope: !2881)
