...
; <label>:2624                                    ; preds = %2623
  call void @__VERIFIER_error(), !dbg !3014
  br label %2625, !dbg !3016

; <label>:2625                                    ; preds = %2624, %2620, %2617, %2614, %2611, %2608, %2605
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label32_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3016 = !DILocation(line: 500, column: 6, scope: !3015)
