...
; <label>:2237                                    ; preds = %2236
  call void @__VERIFIER_error(), !dbg !2580
  br label %2238, !dbg !2582

; <label>:2238                                    ; preds = %2237, %2233, %2230, %2227, %2224, %2221, %2218, %2215
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label57_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2582 = !DILocation(line: 411, column: 6, scope: !2581)
