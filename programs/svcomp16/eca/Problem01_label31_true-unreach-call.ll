...
; <label>:2559                                    ; preds = %2558
  call void @__VERIFIER_error(), !dbg !2930
  br label %2560, !dbg !2932

; <label>:2560                                    ; preds = %2559, %2555, %2552, %2549, %2546, %2543, %2540, %2537
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label31_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2932 = !DILocation(line: 453, column: 6, scope: !2931)
