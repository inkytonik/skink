...
; <label>:2424                                    ; preds = %2423
  call void @__VERIFIER_error(), !dbg !2794
  br label %2425, !dbg !2796

; <label>:2425                                    ; preds = %2424, %2420, %2417, %2414, %2411, %2408, %2405
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label20_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2796 = !DILocation(line: 470, column: 6, scope: !2795)
