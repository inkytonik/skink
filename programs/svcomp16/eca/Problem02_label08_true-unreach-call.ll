...
; <label>:2884                                    ; preds = %2883
  call void @__VERIFIER_error(), !dbg !3300
  br label %2885, !dbg !3302

; <label>:2885                                    ; preds = %2884, %2880, %2877, %2874, %2871, %2868, %2865
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label08_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3302 = !DILocation(line: 539, column: 6, scope: !3301)
