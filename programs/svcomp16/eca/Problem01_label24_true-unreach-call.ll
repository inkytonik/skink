...
; <label>:2697                                    ; preds = %2696
  call void @__VERIFIER_error(), !dbg !3080
  br label %2698, !dbg !3082

; <label>:2698                                    ; preds = %2697, %2693, %2690, %2687, %2684, %2681, %2678, %2675
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label24_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3082 = !DILocation(line: 471, column: 6, scope: !3081)
