...
; <label>:2835                                    ; preds = %2834
  call void @__VERIFIER_error(), !dbg !3230
  br label %2836, !dbg !3232

; <label>:2836                                    ; preds = %2835, %2831, %2828, %2825, %2822, %2819, %2816, %2813
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label07_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3232 = !DILocation(line: 489, column: 6, scope: !3231)
