...
; <label>:2352                                    ; preds = %2351
  call void @__VERIFIER_error(), !dbg !2705
  br label %2353, !dbg !2707

; <label>:2353                                    ; preds = %2352, %2348, %2345, %2342, %2339, %2336, %2333, %2330
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label21_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2707 = !DILocation(line: 426, column: 6, scope: !2706)
