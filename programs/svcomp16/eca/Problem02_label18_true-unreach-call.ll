...
; <label>:2984                                    ; preds = %2983
  call void @__VERIFIER_error(), !dbg !3410
  br label %2985, !dbg !3412

; <label>:2985                                    ; preds = %2984, %2980, %2977, %2974, %2971, %2968, %2965
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label18_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3412 = !DILocation(line: 554, column: 6, scope: !3411)
