...
; <label>:2789                                    ; preds = %2788
  call void @__VERIFIER_error(), !dbg !3180
  br label %2790, !dbg !3182

; <label>:2790                                    ; preds = %2789, %2785, %2782, %2779, %2776, %2773, %2770, %2767
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label36_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3182 = !DILocation(line: 483, column: 6, scope: !3181)
