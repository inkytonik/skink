...
; <label>:2344                                    ; preds = %2343
  call void @__VERIFIER_error(), !dbg !2706
  br label %2345, !dbg !2708

; <label>:2345                                    ; preds = %2344, %2340, %2337, %2334, %2331, %2328, %2325
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label27_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2708 = !DILocation(line: 458, column: 6, scope: !2707)
