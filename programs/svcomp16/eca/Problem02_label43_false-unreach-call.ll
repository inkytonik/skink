...
; <label>:2144                                    ; preds = %2143
  call void @__VERIFIER_error(), !dbg !2486
  br label %2145, !dbg !2488

; <label>:2145                                    ; preds = %2144, %2140, %2137, %2134, %2131, %2128, %2125
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label43_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2488 = !DILocation(line: 428, column: 6, scope: !2487)
