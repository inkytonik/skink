...
; <label>:2524                                    ; preds = %2523
  call void @__VERIFIER_error(), !dbg !2904
  br label %2525, !dbg !2906

; <label>:2525                                    ; preds = %2524, %2520, %2517, %2514, %2511, %2508, %2505
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label52_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2906 = !DILocation(line: 485, column: 6, scope: !2905)
