...
; <label>:2864                                    ; preds = %2863
  call void @__VERIFIER_error(), !dbg !3278
  br label %2865, !dbg !3280

; <label>:2865                                    ; preds = %2864, %2860, %2857, %2854, %2851, %2848, %2845
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label09_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3280 = !DILocation(line: 536, column: 6, scope: !3279)
