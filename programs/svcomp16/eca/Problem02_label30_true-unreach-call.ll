...
; <label>:3004                                    ; preds = %3003
  call void @__VERIFIER_error(), !dbg !3432
  br label %3005, !dbg !3434

; <label>:3005                                    ; preds = %3004, %3000, %2997, %2994, %2991, %2988, %2985
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label30_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3434 = !DILocation(line: 557, column: 6, scope: !3433)
