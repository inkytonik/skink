...
; <label>:2950                                    ; preds = %2949
  call void @__VERIFIER_error(), !dbg !3355
  br label %2951, !dbg !3357

; <label>:2951                                    ; preds = %2950, %2946, %2943, %2940, %2937, %2934, %2931, %2928
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label11_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3357 = !DILocation(line: 504, column: 6, scope: !3356)
