...
; <label>:2444                                    ; preds = %2443
  call void @__VERIFIER_error(), !dbg !2805
  br label %2445, !dbg !2807

; <label>:2445                                    ; preds = %2444, %2440, %2437, %2434, %2431, %2428, %2425, %2422
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label40_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2807 = !DILocation(line: 438, column: 6, scope: !2806)
