...
; <label>:2504                                    ; preds = %2503
  call void @__VERIFIER_error(), !dbg !2882
  br label %2505, !dbg !2884

; <label>:2505                                    ; preds = %2504, %2500, %2497, %2494, %2491, %2488, %2485
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label58_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2884 = !DILocation(line: 482, column: 6, scope: !2883)
