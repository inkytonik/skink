...
; <label>:2204                                    ; preds = %2203
  call void @__VERIFIER_error(), !dbg !2552
  br label %2205, !dbg !2554

; <label>:2205                                    ; preds = %2204, %2200, %2197, %2194, %2191, %2188, %2185
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label44_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2554 = !DILocation(line: 437, column: 6, scope: !2553)
