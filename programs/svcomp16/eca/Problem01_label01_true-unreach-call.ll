...
; <label>:2536                                    ; preds = %2535
  call void @__VERIFIER_error(), !dbg !2905
  br label %2537, !dbg !2907

; <label>:2537                                    ; preds = %2536, %2532, %2529, %2526, %2523, %2520, %2517, %2514
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label01_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2907 = !DILocation(line: 450, column: 6, scope: !2906)
