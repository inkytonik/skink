...
; <label>:2582                                    ; preds = %2581
  call void @__VERIFIER_error(), !dbg !2955
  br label %2583, !dbg !2957

; <label>:2583                                    ; preds = %2582, %2578, %2575, %2572, %2569, %2566, %2563, %2560
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label28_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2957 = !DILocation(line: 456, column: 6, scope: !2956)
