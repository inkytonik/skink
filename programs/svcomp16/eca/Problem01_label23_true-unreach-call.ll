...
; <label>:2628                                    ; preds = %2627
  call void @__VERIFIER_error(), !dbg !3005
  br label %2629, !dbg !3007

; <label>:2629                                    ; preds = %2628, %2624, %2621, %2618, %2615, %2612, %2609, %2606
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label23_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3007 = !DILocation(line: 462, column: 6, scope: !3006)
