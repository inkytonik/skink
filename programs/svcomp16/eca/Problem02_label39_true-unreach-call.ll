...
; <label>:2664                                    ; preds = %2663
  call void @__VERIFIER_error(), !dbg !3058
  br label %2665, !dbg !3060

; <label>:2665                                    ; preds = %2664, %2660, %2657, %2654, %2651, %2648, %2645
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label39_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3060 = !DILocation(line: 506, column: 6, scope: !3059)
