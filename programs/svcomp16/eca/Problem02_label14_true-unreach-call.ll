...
; <label>:2784                                    ; preds = %2783
  call void @__VERIFIER_error(), !dbg !3190
  br label %2785, !dbg !3192

; <label>:2785                                    ; preds = %2784, %2780, %2777, %2774, %2771, %2768, %2765
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label14_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3192 = !DILocation(line: 524, column: 6, scope: !3191)
