...
; <label>:2404                                    ; preds = %2403
  call void @__VERIFIER_error(), !dbg !2772
  br label %2405, !dbg !2774

; <label>:2405                                    ; preds = %2404, %2400, %2397, %2394, %2391, %2388, %2385
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label34_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2774 = !DILocation(line: 467, column: 6, scope: !2773)
