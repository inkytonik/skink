...
; <label>:2964                                    ; preds = %2963
  call void @__VERIFIER_error(), !dbg !3388
  br label %2965, !dbg !3390

; <label>:2965                                    ; preds = %2964, %2960, %2957, %2954, %2951, %2948, %2945
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label05_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3390 = !DILocation(line: 551, column: 6, scope: !3389)
