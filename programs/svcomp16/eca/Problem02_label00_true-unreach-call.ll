...
; <label>:2744                                    ; preds = %2743
  call void @__VERIFIER_error(), !dbg !3146
  br label %2745, !dbg !3148

; <label>:2745                                    ; preds = %2744, %2740, %2737, %2734, %2731, %2728, %2725
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label00_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3148 = !DILocation(line: 518, column: 6, scope: !3147)
