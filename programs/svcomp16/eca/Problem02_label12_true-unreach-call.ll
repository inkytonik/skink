...
; <label>:2804                                    ; preds = %2803
  call void @__VERIFIER_error(), !dbg !3212
  br label %2805, !dbg !3214

; <label>:2805                                    ; preds = %2804, %2800, %2797, %2794, %2791, %2788, %2785
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label12_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3214 = !DILocation(line: 527, column: 6, scope: !3213)
