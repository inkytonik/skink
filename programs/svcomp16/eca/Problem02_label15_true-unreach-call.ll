...
; <label>:3044                                    ; preds = %3043
  call void @__VERIFIER_error(), !dbg !3476
  br label %3045, !dbg !3478

; <label>:3045                                    ; preds = %3044, %3040, %3037, %3034, %3031, %3028, %3025
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label15_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3478 = !DILocation(line: 563, column: 6, scope: !3477)
