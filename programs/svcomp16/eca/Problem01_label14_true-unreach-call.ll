...
; <label>:3456                                    ; preds = %3455
  call void @__VERIFIER_error(), !dbg !3905
  br label %3457, !dbg !3907

; <label>:3457                                    ; preds = %3456, %3452, %3449, %3446, %3443, %3440, %3437, %3434
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label14_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3907 = !DILocation(line: 570, column: 6, scope: !3906)
