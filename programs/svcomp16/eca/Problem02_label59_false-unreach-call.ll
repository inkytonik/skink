...
; <label>:2104                                    ; preds = %2103
  call void @__VERIFIER_error(), !dbg !2442
  br label %2105, !dbg !2444

; <label>:2105                                    ; preds = %2104, %2100, %2097, %2094, %2091, %2088, %2085
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label59_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2444 = !DILocation(line: 422, column: 6, scope: !2443)
