...
; <label>:2329                                    ; preds = %2328
  call void @__VERIFIER_error(), !dbg !2680
  br label %2330, !dbg !2682

; <label>:2330                                    ; preds = %2329, %2325, %2322, %2319, %2316, %2313, %2310, %2307
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label38_false-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2682 = !DILocation(line: 423, column: 6, scope: !2681)
