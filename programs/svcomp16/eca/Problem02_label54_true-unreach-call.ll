...
; <label>:2464                                    ; preds = %2463
  call void @__VERIFIER_error(), !dbg !2838
  br label %2465, !dbg !2840

; <label>:2465                                    ; preds = %2464, %2460, %2457, %2454, %2451, %2448, %2445
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem02_label54_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!2840 = !DILocation(line: 476, column: 6, scope: !2839)
