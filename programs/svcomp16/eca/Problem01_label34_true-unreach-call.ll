...
; <label>:2858                                    ; preds = %2857
  call void @__VERIFIER_error(), !dbg !3255
  br label %2859, !dbg !3257

; <label>:2859                                    ; preds = %2858, %2854, %2851, %2848, %2845, %2842, %2839, %2836
...
!1 = !DIFile(filename: "../sv-comp-2016/c/eca-rers2012/Problem01_label34_true-unreach-call.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4, !8}
...
!3257 = !DILocation(line: 492, column: 6, scope: !3256)
