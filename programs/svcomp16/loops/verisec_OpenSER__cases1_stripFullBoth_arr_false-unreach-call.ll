...
; <label>:105                                     ; preds = %101
  %106 = getelementptr inbounds [2 x i8], [2 x i8]* %str2.i, i32 0, i32 0
  %107 = load i8*, i8** %2, align 8
  %108 = load i32, i32* %start.i, align 4
  %109 = sext i32 %108 to i64
  %110 = getelementptr inbounds i8, i8* %107, i64 %109
  %111 = load i32, i32* %j.i, align 4
  %112 = load i32, i32* %start.i, align 4
  %113 = sub nsw i32 %111, %112
  %114 = add nsw i32 %113, 1
  %115 = call i8* @r_strncpy(i8* %106, i8* %110, i32 %114) #2
  %116 = load i32, i32* %j.i, align 4
  %117 = load i32, i32* %start.i, align 4
  %118 = sub nsw i32 %116, %117
  %119 = add nsw i32 %118, 1
  %120 = icmp slt i32 %119, 2
  %121 = zext i1 %120 to i32
  %122 = call i32 (i32, ...) bitcast (i32 (...)* @__VERIFIER_assert to i32 (i32, ...)*)(i32 %121) #2
...
parse_expression_list.exit:                       ; preds = %14, %131, %140
  %141 = load i32, i32* %1
