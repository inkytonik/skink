...
if.then48.i:                                      ; preds = %if.end45.i
  ...
  %sub49.i = sub nsw i32 %41, %42
  %add.i = add nsw i32 %sub49.i, 1
  %cmp50.i = icmp sge i32 %add.i, 2
...
if.end53.i:                                       ; preds = %if.then48.i
  ...
  %43 = load i8*, i8** %str.addr.i, align 8
  %44 = load i32, i32* %start.i, align 4
  %idx.ext.i = sext i32 %44 to i64
  %add.ptr.i = getelementptr inbounds i8, i8* %43, i64 %idx.ext.i
  %45 = load i32, i32* %j.i, align 4
  %46 = load i32, i32* %start.i, align 4
  %sub54.i = sub nsw i32 %45, %46
  %add55.i = add nsw i32 %sub54.i, 1
  %call.i = call i8* @r_strncpy(i8* %arraydecay.i, i8* %add.ptr.i, i32 %add55.i) #2
  %47 = load i32, i32* %j.i, align 4
  %48 = load i32, i32* %start.i, align 4
  %sub56.i = sub nsw i32 %47, %48
  %add57.i = add nsw i32 %sub56.i, 1
  %idxprom58.i = sext i32 %add57.i to i64
  %arrayidx59.i = getelementptr inbounds [2 x i8], [2 x i8]* %str2.i, i32 0, i64 %idxprom58.i
  store i8 0, i8* %arrayidx59.i, align 1
  %49 = load i32, i32* %i.i, align 4
  %add61.i = add nsw i32 %49, 1
  store i32 %add61.i, i32* %start.i, align 4
...
sw.epilog.i:                                      ; preds = %do.body.i, %if.end53.i
  %50 = load i32, i32* %i.i, align 4
  %idxprom62.i = sext i32 %50 to i64
  %51 = load i8*, i8** %str.addr.i, align 8
  %arrayidx63.i = getelementptr inbounds i8, i8* %51, i64 %idxprom62.i
  %52 = load i8, i8* %arrayidx63.i, align 1
  %conv64.i = sext i8 %52 to i32
  %cmp65.i = icmp ne i32 %conv64.i, 0
  br i1 %cmp65.i, label %do.body.i, label %do.end.i

do.end.i:                                         ; preds = %sw.epilog.i
  store i32 0, i32* %retval.i
  br label %parse_expression_list.exit

parse_expression_list.exit:                       ; preds = %if.then.i, %if.then52.i, %if.else.i, %do.end.i
