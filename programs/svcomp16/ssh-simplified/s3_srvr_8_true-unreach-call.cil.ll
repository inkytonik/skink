...
; <label>:59                                      ; preds = %56
  ...
  br label %627, !dbg !212

; <label>:60                                      ; preds = %56
  br label %61, !dbg !214

; <label>:61                                      ; preds = %616, %60
  br label %62, !dbg !216
...
; <label>:202                                     ; preds = %199
  br label %538, !dbg !462

; <label>:203                                     ; preds = %199
  br label %549, !dbg !464
                                                  ; No predecessors!
  br i1 false, label %205, label %550, !dbg !466
...
; <label>:258                                     ; preds = %253
  ...
  br label %551, !dbg !550

; <label>:259                                     ; preds = %94
  store i32 3, i32* %s__state, align 4, !dbg !551
  br label %551, !dbg !552
...
; <label>:457                                     ; preds = %456, %182
  ...
  %460 = icmp eq i32 %459, 4, !dbg !864
  br i1 %460, label %461, label %462, !dbg !865

; <label>:461                                     ; preds = %457
  store i32 5, i32* %blastFlag, align 4, !dbg !866
  br label %472, !dbg !868

; <label>:462                                     ; preds = %457
  %463 = load i32, i32* %blastFlag, align 4, !dbg !869
  %464 = icmp eq i32 %463, 7, !dbg !872
  br i1 %464, label %465, label %466, !dbg !873

; <label>:465                                     ; preds = %462
  store i32 8, i32* %blastFlag, align 4, !dbg !874
  br label %471, !dbg !876

; <label>:466                                     ; preds = %462
  %467 = load i32, i32* %blastFlag, align 4, !dbg !877
  %468 = icmp eq i32 %467, 10, !dbg !880
  br i1 %468, label %469, label %470, !dbg !881

; <label>:469                                     ; preds = %466
  br label %626, !dbg !882
...
; <label>:472                                     ; preds = %471, %461
  %473 = load i32, i32* %ret, align 4, !dbg !884
  %474 = icmp sle i32 %473, 0, !dbg !886
  br i1 %474, label %475, label %476, !dbg !887

; <label>:475                                     ; preds = %472
  br label %618, !dbg !888

; <label>:476                                     ; preds = %472
  %477 = load i32, i32* %s__hit, align 4, !dbg !890
  %478 = icmp ne i32 %477, 0, !dbg !890
  br i1 %478, label %479, label %480, !dbg !892

; <label>:479                                     ; preds = %476
  store i32 3, i32* %s__state, align 4, !dbg !893
  br label %481, !dbg !895
...
; <label>:481                                     ; preds = %480, %479
  ...
  br label %551, !dbg !899

; <label>:482                                     ; preds = %186
  br label %483, !dbg !899

; <label>:483                                     ; preds = %482, %190
  %484 = load i32, i32* %s__s3__tmp__new_cipher, align 4, !dbg !900
  store i32 %484, i32* %s__session__cipher, align 4, !dbg !901
  %485 = load i32, i32* %tmp___9, align 4, !dbg !902
  %486 = icmp ne i32 %485, 0, !dbg !902
  br i1 %486, label %488, label %487, !dbg !904

; <label>:487                                     ; preds = %483
  store i32 -1, i32* %ret, align 4, !dbg !905
  br label %618, !dbg !907

; <label>:488                                     ; preds = %483
  %489 = call i32 @__VERIFIER_nondet_int(), !dbg !908
  store i32 %489, i32* %ret, align 4, !dbg !909
  %490 = load i32, i32* %blastFlag, align 4, !dbg !910
  %491 = icmp eq i32 %490, 2, !dbg !912
  br i1 %491, label %492, label %493, !dbg !913

; <label>:492                                     ; preds = %488
  store i32 3, i32* %blastFlag, align 4, !dbg !914
  br label %503, !dbg !916

; <label>:493                                     ; preds = %488
  %494 = load i32, i32* %blastFlag, align 4, !dbg !917
  %495 = icmp eq i32 %494, 5, !dbg !920
  br i1 %495, label %496, label %497, !dbg !921

; <label>:496                                     ; preds = %493
  store i32 6, i32* %blastFlag, align 4, !dbg !922
  br label %502, !dbg !924

; <label>:497                                     ; preds = %493
  %498 = load i32, i32* %blastFlag, align 4, !dbg !925
  %499 = icmp eq i32 %498, 8, !dbg !928
  br i1 %499, label %500, label %501, !dbg !929

; <label>:500                                     ; preds = %497
  store i32 9, i32* %blastFlag, align 4, !dbg !930
  br label %501, !dbg !932
...
; <label>:503                                     ; preds = %502, %492
  %504 = load i32, i32* %ret, align 4, !dbg !933
  %505 = icmp sle i32 %504, 0, !dbg !935
  br i1 %505, label %506, label %507, !dbg !936

; <label>:506                                     ; preds = %503
  br label %618, !dbg !937

; <label>:507                                     ; preds = %503
  store i32 8672, i32* %s__state, align 4, !dbg !939
  store i32 0, i32* %s__init_num, align 4, !dbg !940
  %508 = load i32, i32* %tmp___10, align 4, !dbg !941
  %509 = icmp ne i32 %508, 0, !dbg !941
  br i1 %509, label %511, label %510, !dbg !943

; <label>:510                                     ; preds = %507
  store i32 -1, i32* %ret, align 4, !dbg !944
  br label %618, !dbg !946

; <label>:511                                     ; preds = %507
  br label %551, !dbg !947

; <label>:512                                     ; preds = %194
  br label %513, !dbg !947

; <label>:513                                     ; preds = %512, %198
  %514 = call i32 @__VERIFIER_nondet_int(), !dbg !948
  store i32 %514, i32* %ret, align 4, !dbg !949
  %515 = load i32, i32* %blastFlag, align 4, !dbg !950
  %516 = icmp eq i32 %515, 3, !dbg !952
  br i1 %516, label %517, label %518, !dbg !953

; <label>:517                                     ; preds = %513
  store i32 4, i32* %blastFlag, align 4, !dbg !954
  br label %528, !dbg !956

; <label>:518                                     ; preds = %513
  %519 = load i32, i32* %blastFlag, align 4, !dbg !957
  %520 = icmp eq i32 %519, 6, !dbg !960
  br i1 %520, label %521, label %522, !dbg !961

; <label>:521                                     ; preds = %518
  store i32 7, i32* %blastFlag, align 4, !dbg !962
  br label %527, !dbg !964

; <label>:522                                     ; preds = %518
  %523 = load i32, i32* %blastFlag, align 4, !dbg !965
  %524 = icmp eq i32 %523, 9, !dbg !968
  br i1 %524, label %525, label %526, !dbg !969

; <label>:525                                     ; preds = %522
  store i32 10, i32* %blastFlag, align 4, !dbg !970
  br label %526, !dbg !972

; <label>:526                                     ; preds = %525, %522
  br label %527

; <label>:527                                     ; preds = %526, %521
  br label %528

; <label>:528                                     ; preds = %527, %517
  %529 = load i32, i32* %ret, align 4, !dbg !973
  %530 = icmp sle i32 %529, 0, !dbg !975
  br i1 %530, label %531, label %532, !dbg !976

; <label>:531                                     ; preds = %528
  br label %618, !dbg !977

; <label>:532                                     ; preds = %528
  store i32 8448, i32* %s__state, align 4, !dbg !979
  %533 = load i32, i32* %s__hit, align 4, !dbg !980
  %534 = icmp ne i32 %533, 0, !dbg !980
  br i1 %534, label %535, label %536, !dbg !982
...
; <label>:537                                     ; preds = %536, %535
  ...
  br label %551, !dbg !989

; <label>:538                                     ; preds = %202
  store i32 0, i32* %s__init_buf___0, align 4, !dbg !990
  store i32 0, i32* %s__init_num, align 4, !dbg !991
  %539 = load i32, i32* %got_new_session, align 4, !dbg !992
  %540 = icmp ne i32 %539, 0, !dbg !992
  br i1 %540, label %541, label %548, !dbg !994

; <label>:541                                     ; preds = %538
  store i32 0, i32* %s__new_session, align 4, !dbg !995
  %542 = load i32, i32* %s__ctx__stats__sess_accept_good, align 4, !dbg !997
  %543 = add nsw i32 %542, 1, !dbg !997
  store i32 %543, i32* %s__ctx__stats__sess_accept_good, align 4, !dbg !997
  %544 = load i32, i32* %cb, align 4, !dbg !998
  %545 = icmp ne i32 %544, 0, !dbg !1000
  br i1 %545, label %546, label %547, !dbg !1001
...
; <label>:548                                     ; preds = %547, %538
  ...
  br label %618, !dbg !1006

; <label>:549                                     ; preds = %203
  store i32 -1, i32* %ret, align 4, !dbg !1007
  br label %618, !dbg !1008

; <label>:550                                     ; preds = %204
  br label %551, !dbg !1009

; <label>:551                                     ; preds = %550, %537, %511, %481, %455, %448, %441, %423, %413, %406, %366, %302, %287, %271, %259, %258, %251
  br label %552
...
; <label>:587                                     ; preds = %586
  %588 = load i32, i32* %s__s3__tmp__reuse_message, align 4, !dbg !1010
  %589 = icmp ne i32 %588, 0, !dbg !1010
  br i1 %589, label %616, label %590, !dbg !1012

; <label>:590                                     ; preds = %587
  %591 = load i32, i32* %skip, align 4, !dbg !1013
  %592 = icmp ne i32 %591, 0, !dbg !1013
  br i1 %592, label %615, label %593, !dbg !1016

; <label>:593                                     ; preds = %590
  %594 = load i32, i32* %s__debug, align 4, !dbg !1017
  %595 = icmp ne i32 %594, 0, !dbg !1017
  br i1 %595, label %596, label %602, !dbg !1020

; <label>:596                                     ; preds = %593
  %597 = call i32 @__VERIFIER_nondet_int(), !dbg !1021
  store i32 %597, i32* %ret, align 4, !dbg !1023
  %598 = load i32, i32* %ret, align 4, !dbg !1024
  %599 = icmp sle i32 %598, 0, !dbg !1026
  br i1 %599, label %600, label %601, !dbg !1027

; <label>:600                                     ; preds = %596
  br label %618, !dbg !1028

; <label>:601                                     ; preds = %596
  br label %602, !dbg !1030

; <label>:602                                     ; preds = %601, %593
  %603 = load i32, i32* %cb, align 4, !dbg !1031
  %604 = icmp ne i32 %603, 0, !dbg !1033
  br i1 %604, label %605, label %614, !dbg !1034

; <label>:605                                     ; preds = %602
  %606 = load i32, i32* %s__state, align 4, !dbg !1035
  %607 = load i32, i32* %state, align 4, !dbg !1038
  %608 = icmp ne i32 %606, %607, !dbg !1039
  br i1 %608, label %609, label %613, !dbg !1040

; <label>:609                                     ; preds = %605
  %610 = load i32, i32* %s__state, align 4, !dbg !1041
  store i32 %610, i32* %new_state, align 4, !dbg !1043
  %611 = load i32, i32* %state, align 4, !dbg !1044
  store i32 %611, i32* %s__state, align 4, !dbg !1045
  %612 = load i32, i32* %new_state, align 4, !dbg !1046
  store i32 %612, i32* %s__state, align 4, !dbg !1047
  br label %613, !dbg !1048

; <label>:613                                     ; preds = %609, %605
  br label %614, !dbg !1049

; <label>:614                                     ; preds = %613, %602
  br label %615, !dbg !1050

; <label>:615                                     ; preds = %614, %590
  br label %616, !dbg !1051

; <label>:616                                     ; preds = %615, %587
  store i32 0, i32* %skip, align 4, !dbg !1052
  br label %61, !dbg !214
                                                  ; No predecessors!
  br label %618, !dbg !1053

; <label>:618                                     ; preds = %617, %600, %549, %548, %531, %510, %506, %487, %475, %454, %447, %439, %430, %421, %412, %401, %356, %300, %281, %270, %257, %244, %237, %231, %227
  %619 = load i32, i32* %s__in_handshake, align 4, !dbg !1054
  %620 = add nsw i32 %619, -1, !dbg !1054
  store i32 %620, i32* %s__in_handshake, align 4, !dbg !1054
  %621 = load i32, i32* %cb, align 4, !dbg !1055
  %622 = icmp ne i32 %621, 0, !dbg !1057
  br i1 %622, label %623, label %624, !dbg !1058

; <label>:623                                     ; preds = %618
  br label %624, !dbg !1059

; <label>:624                                     ; preds = %623, %618
  %625 = load i32, i32* %ret, align 4, !dbg !1061
  store i32 %625, i32* %1, !dbg !1062
  br label %627, !dbg !1062

; <label>:626                                     ; preds = %469
  call void (...) @__VERIFIER_error() #4, !dbg !1063
  unreachable, !dbg !1063

; <label>:627                                     ; preds = %624, %219, %59
  %628 = load i32, i32* %1, !dbg !1064
  ret i32 %628, !dbg !1064
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @llvm.dbg.declare(metadata i32* %s, metadata !1065, metadata !18), !dbg !1066
  call void @llvm.dbg.declare(metadata i32* %tmp, metadata !1067, metadata !18), !dbg !1068
  store i32 8464, i32* %s, align 4, !dbg !1069
  %2 = load i32, i32* %s, align 4, !dbg !1072
  %3 = call i32 @ssl3_accept(i32 %2), !dbg !1073
  store i32 %3, i32* %tmp, align 4, !dbg !1074
  %4 = load i32, i32* %tmp, align 4, !dbg !1075
  ret i32 %4, !dbg !1076
}
...
!1 = !DIFile(filename: "svcomp16/ssh-simplified/s3_srvr_8_true-unreach-call.cil.c", directory: ".")
!2 = !{}
!3 = !{!4}
...
!10 = !DISubprogram(name: "main", scope: !1, file: !1, line: 635, type: !11, isLocal: false, isDefinition: true, scopeLine: 636, flags: DIFlagPrototyped, isOptimized: false, function: i32 ()* @main, variables: !2)
...
!1017 = !DILocation(line: 605, column: 13, scope: !1018)
!1018 = distinct !DILexicalBlock(scope: !1019, file: !1, line: 605, column: 13)
!1019 = distinct !DILexicalBlock(scope: !1014, file: !1, line: 604, column: 19)
!1020 = !DILocation(line: 605, column: 13, scope: !1019)
!1021 = !DILocation(line: 606, column: 17, scope: !1022)
!1022 = distinct !DILexicalBlock(scope: !1018, file: !1, line: 605, column: 23)
!1023 = !DILocation(line: 606, column: 15, scope: !1022)
!1024 = !DILocation(line: 607, column: 15, scope: !1025)
!1025 = distinct !DILexicalBlock(scope: !1022, file: !1, line: 607, column: 15)
!1026 = !DILocation(line: 607, column: 19, scope: !1025)
!1027 = !DILocation(line: 607, column: 15, scope: !1022)
!1028 = !DILocation(line: 608, column: 13, scope: !1029)
!1029 = distinct !DILexicalBlock(scope: !1025, file: !1, line: 607, column: 25)
!1030 = !DILocation(line: 610, column: 9, scope: !1022)
!1031 = !DILocation(line: 611, column: 13, scope: !1032)
!1032 = distinct !DILexicalBlock(scope: !1019, file: !1, line: 611, column: 13)
!1033 = !DILocation(line: 611, column: 16, scope: !1032)
!1034 = !DILocation(line: 611, column: 13, scope: !1019)
!1035 = !DILocation(line: 612, column: 15, scope: !1036)
!1036 = distinct !DILexicalBlock(scope: !1037, file: !1, line: 612, column: 15)
!1037 = distinct !DILexicalBlock(scope: !1032, file: !1, line: 611, column: 22)
!1038 = !DILocation(line: 612, column: 27, scope: !1036)
!1039 = !DILocation(line: 612, column: 24, scope: !1036)
!1040 = !DILocation(line: 612, column: 15, scope: !1037)
!1041 = !DILocation(line: 613, column: 25, scope: !1042)
!1042 = distinct !DILexicalBlock(scope: !1036, file: !1, line: 612, column: 34)
!1043 = !DILocation(line: 613, column: 23, scope: !1042)
!1044 = !DILocation(line: 614, column: 24, scope: !1042)
!1045 = !DILocation(line: 614, column: 22, scope: !1042)
!1046 = !DILocation(line: 615, column: 24, scope: !1042)
!1047 = !DILocation(line: 615, column: 22, scope: !1042)
!1048 = !DILocation(line: 616, column: 11, scope: !1042)
!1049 = !DILocation(line: 617, column: 9, scope: !1037)
!1050 = !DILocation(line: 618, column: 7, scope: !1019)
!1051 = !DILocation(line: 619, column: 5, scope: !1015)
!1052 = !DILocation(line: 620, column: 10, scope: !218)
!1053 = !DILocation(line: 623, column: 3, scope: !215)
!1054 = !DILocation(line: 626, column: 19, scope: !167)
!1055 = !DILocation(line: 627, column: 7, scope: !1056)
!1056 = distinct !DILexicalBlock(scope: !167, file: !1, line: 627, column: 7)
!1057 = !DILocation(line: 627, column: 10, scope: !1056)
!1058 = !DILocation(line: 627, column: 7, scope: !167)
!1059 = !DILocation(line: 629, column: 3, scope: !1060)
!1060 = distinct !DILexicalBlock(scope: !1056, file: !1, line: 627, column: 16)
!1061 = !DILocation(line: 630, column: 11, scope: !167)
!1062 = !DILocation(line: 630, column: 3, scope: !167)
!1063 = !DILocation(line: 631, column: 10, scope: !167)
!1064 = !DILocation(line: 634, column: 1, scope: !6)
!1065 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "s", scope: !10, file: !1, line: 636, type: !9)
!1066 = !DILocation(line: 636, column: 7, scope: !10)
!1067 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "tmp", scope: !10, file: !1, line: 637, type: !9)
!1068 = !DILocation(line: 637, column: 7, scope: !10)
!1069 = !DILocation(line: 641, column: 5, scope: !1070)
!1070 = distinct !DILexicalBlock(scope: !1071, file: !1, line: 640, column: 3)
!1071 = distinct !DILexicalBlock(scope: !10, file: !1, line: 639, column: 3)
!1072 = !DILocation(line: 642, column: 21, scope: !1070)
!1073 = !DILocation(line: 642, column: 9, scope: !1070)
!1074 = !DILocation(line: 642, column: 7, scope: !1070)
!1075 = !DILocation(line: 644, column: 11, scope: !1071)
!1076 = !DILocation(line: 644, column: 3, scope: !1071)
