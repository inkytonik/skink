...
; <label>:202                                     ; preds = %199
  br label %538, !dbg !463

; <label>:203                                     ; preds = %199
  br label %549, !dbg !465
                                                  ; No predecessors!
  br i1 false, label %205, label %550, !dbg !467
...
; <label>:258                                     ; preds = %253
  ...
  br label %551, !dbg !551

; <label>:259                                     ; preds = %94
  store i32 3, i32* %s__state, align 4, !dbg !552
  br label %551, !dbg !553
...
; <label>:457                                     ; preds = %456, %182
  ...
  %460 = icmp eq i32 %459, 4, !dbg !865
  br i1 %460, label %461, label %462, !dbg !866

; <label>:461                                     ; preds = %457
  store i32 5, i32* %blastFlag, align 4, !dbg !867
  br label %472, !dbg !869

; <label>:462                                     ; preds = %457
  %463 = load i32, i32* %blastFlag, align 4, !dbg !870
  %464 = icmp eq i32 %463, 7, !dbg !873
  br i1 %464, label %465, label %466, !dbg !874

; <label>:465                                     ; preds = %462
  store i32 8, i32* %blastFlag, align 4, !dbg !875
  br label %471, !dbg !877

; <label>:466                                     ; preds = %462
  %467 = load i32, i32* %blastFlag, align 4, !dbg !878
  %468 = icmp eq i32 %467, 10, !dbg !881
  br i1 %468, label %469, label %470, !dbg !882

; <label>:469                                     ; preds = %466
  br label %626, !dbg !883
...
; <label>:472                                     ; preds = %471, %461
  %473 = load i32, i32* %ret, align 4, !dbg !885
  %474 = icmp sle i32 %473, 0, !dbg !887
  br i1 %474, label %475, label %476, !dbg !888

; <label>:475                                     ; preds = %472
  br label %618, !dbg !889

; <label>:476                                     ; preds = %472
  %477 = load i32, i32* %s__hit, align 4, !dbg !891
  %478 = icmp ne i32 %477, 0, !dbg !891
  br i1 %478, label %479, label %480, !dbg !893

; <label>:479                                     ; preds = %476
  store i32 3, i32* %s__state, align 4, !dbg !894
  br label %481, !dbg !896
...
; <label>:481                                     ; preds = %480, %479
  ...
  br label %551, !dbg !900

; <label>:482                                     ; preds = %186
  br label %483, !dbg !900

; <label>:483                                     ; preds = %482, %190
  %484 = load i32, i32* %s__s3__tmp__new_cipher, align 4, !dbg !901
  store i32 %484, i32* %s__session__cipher, align 4, !dbg !902
  %485 = load i32, i32* %tmp___9, align 4, !dbg !903
  %486 = icmp ne i32 %485, 0, !dbg !903
  br i1 %486, label %488, label %487, !dbg !905

; <label>:487                                     ; preds = %483
  store i32 -1, i32* %ret, align 4, !dbg !906
  br label %618, !dbg !908

; <label>:488                                     ; preds = %483
  %489 = call i32 @__VERIFIER_nondet_int(), !dbg !909
  store i32 %489, i32* %ret, align 4, !dbg !910
  %490 = load i32, i32* %blastFlag, align 4, !dbg !911
  %491 = icmp eq i32 %490, 2, !dbg !913
  br i1 %491, label %492, label %493, !dbg !914

; <label>:492                                     ; preds = %488
  store i32 3, i32* %blastFlag, align 4, !dbg !915
  br label %503, !dbg !917

; <label>:493                                     ; preds = %488
  %494 = load i32, i32* %blastFlag, align 4, !dbg !918
  %495 = icmp eq i32 %494, 5, !dbg !921
  br i1 %495, label %496, label %497, !dbg !922

; <label>:496                                     ; preds = %493
  store i32 6, i32* %blastFlag, align 4, !dbg !923
  br label %502, !dbg !925

; <label>:497                                     ; preds = %493
  %498 = load i32, i32* %blastFlag, align 4, !dbg !926
  %499 = icmp eq i32 %498, 8, !dbg !929
  br i1 %499, label %500, label %501, !dbg !930

; <label>:500                                     ; preds = %497
  store i32 9, i32* %blastFlag, align 4, !dbg !931
  br label %501, !dbg !933
...
; <label>:503                                     ; preds = %502, %492
  %504 = load i32, i32* %ret, align 4, !dbg !934
  %505 = icmp sle i32 %504, 0, !dbg !936
  br i1 %505, label %506, label %507, !dbg !937

; <label>:506                                     ; preds = %503
  br label %618, !dbg !938

; <label>:507                                     ; preds = %503
  store i32 8672, i32* %s__state, align 4, !dbg !940
  store i32 0, i32* %s__init_num, align 4, !dbg !941
  %508 = load i32, i32* %tmp___10, align 4, !dbg !942
  %509 = icmp ne i32 %508, 0, !dbg !942
  br i1 %509, label %511, label %510, !dbg !944

; <label>:510                                     ; preds = %507
  store i32 -1, i32* %ret, align 4, !dbg !945
  br label %618, !dbg !947

; <label>:511                                     ; preds = %507
  br label %551, !dbg !948

; <label>:512                                     ; preds = %194
  br label %513, !dbg !948

; <label>:513                                     ; preds = %512, %198
  %514 = call i32 @__VERIFIER_nondet_int(), !dbg !949
  store i32 %514, i32* %ret, align 4, !dbg !950
  %515 = load i32, i32* %blastFlag, align 4, !dbg !951
  %516 = icmp eq i32 %515, 3, !dbg !953
  br i1 %516, label %517, label %518, !dbg !954

; <label>:517                                     ; preds = %513
  store i32 4, i32* %blastFlag, align 4, !dbg !955
  br label %528, !dbg !957

; <label>:518                                     ; preds = %513
  %519 = load i32, i32* %blastFlag, align 4, !dbg !958
  %520 = icmp eq i32 %519, 6, !dbg !961
  br i1 %520, label %521, label %522, !dbg !962

; <label>:521                                     ; preds = %518
  store i32 7, i32* %blastFlag, align 4, !dbg !963
  br label %527, !dbg !965

; <label>:522                                     ; preds = %518
  %523 = load i32, i32* %blastFlag, align 4, !dbg !966
  %524 = icmp eq i32 %523, 9, !dbg !969
  br i1 %524, label %525, label %526, !dbg !970

; <label>:525                                     ; preds = %522
  store i32 10, i32* %blastFlag, align 4, !dbg !971
  br label %526, !dbg !973
...
; <label>:528                                     ; preds = %527, %517
  %529 = load i32, i32* %ret, align 4, !dbg !974
  %530 = icmp sle i32 %529, 0, !dbg !976
  br i1 %530, label %531, label %532, !dbg !977

; <label>:531                                     ; preds = %528
  br label %618, !dbg !978

; <label>:532                                     ; preds = %528
  store i32 8448, i32* %s__state, align 4, !dbg !980
  %533 = load i32, i32* %s__hit, align 4, !dbg !981
  %534 = icmp ne i32 %533, 0, !dbg !981
  br i1 %534, label %535, label %536, !dbg !983

; <label>:535                                     ; preds = %532
  store i32 8640, i32* %s__s3__tmp__next_state___0, align 4, !dbg !984
  br label %537, !dbg !986
...
; <label>:537                                     ; preds = %536, %535
  ...
  br label %551, !dbg !990

; <label>:538                                     ; preds = %202
  store i32 0, i32* %s__init_buf___0, align 4, !dbg !991
  store i32 0, i32* %s__init_num, align 4, !dbg !992
  %539 = load i32, i32* %got_new_session, align 4, !dbg !993
  %540 = icmp ne i32 %539, 0, !dbg !993
  br i1 %540, label %541, label %548, !dbg !995

; <label>:541                                     ; preds = %538
  store i32 0, i32* %s__new_session, align 4, !dbg !996
  %542 = load i32, i32* %s__ctx__stats__sess_accept_good, align 4, !dbg !998
  %543 = add nsw i32 %542, 1, !dbg !998
  store i32 %543, i32* %s__ctx__stats__sess_accept_good, align 4, !dbg !998
  %544 = load i32, i32* %cb, align 4, !dbg !999
  %545 = icmp ne i32 %544, 0, !dbg !1001
  br i1 %545, label %546, label %547, !dbg !1002

; <label>:546                                     ; preds = %541
  br label %547, !dbg !1003

; <label>:547                                     ; preds = %546, %541
  br label %548, !dbg !1005

; <label>:548                                     ; preds = %547, %538
  store i32 1, i32* %ret, align 4, !dbg !1006
  br label %618, !dbg !1007

; <label>:549                                     ; preds = %203
  store i32 -1, i32* %ret, align 4, !dbg !1008
  br label %618, !dbg !1009

; <label>:550                                     ; preds = %204
  br label %551, !dbg !1010
...
; <label>:587                                     ; preds = %586
  %588 = load i32, i32* %s__s3__tmp__reuse_message, align 4, !dbg !1011
  %589 = icmp ne i32 %588, 0, !dbg !1011
  br i1 %589, label %616, label %590, !dbg !1013

; <label>:590                                     ; preds = %587
  %591 = load i32, i32* %skip, align 4, !dbg !1014
  %592 = icmp ne i32 %591, 0, !dbg !1014
  br i1 %592, label %615, label %593, !dbg !1017

; <label>:593                                     ; preds = %590
  %594 = load i32, i32* %s__debug, align 4, !dbg !1018
  %595 = icmp ne i32 %594, 0, !dbg !1018
  br i1 %595, label %596, label %602, !dbg !1021

; <label>:596                                     ; preds = %593
  %597 = call i32 @__VERIFIER_nondet_int(), !dbg !1022
  store i32 %597, i32* %ret, align 4, !dbg !1024
  %598 = load i32, i32* %ret, align 4, !dbg !1025
  %599 = icmp sle i32 %598, 0, !dbg !1027
  br i1 %599, label %600, label %601, !dbg !1028

; <label>:600                                     ; preds = %596
  br label %618, !dbg !1029

; <label>:601                                     ; preds = %596
  br label %602, !dbg !1031

; <label>:602                                     ; preds = %601, %593
  %603 = load i32, i32* %cb, align 4, !dbg !1032
  %604 = icmp ne i32 %603, 0, !dbg !1034
  br i1 %604, label %605, label %614, !dbg !1035

; <label>:605                                     ; preds = %602
  %606 = load i32, i32* %s__state, align 4, !dbg !1036
  %607 = load i32, i32* %state, align 4, !dbg !1039
  %608 = icmp ne i32 %606, %607, !dbg !1040
  br i1 %608, label %609, label %613, !dbg !1041

; <label>:609                                     ; preds = %605
  %610 = load i32, i32* %s__state, align 4, !dbg !1042
  store i32 %610, i32* %new_state, align 4, !dbg !1044
  %611 = load i32, i32* %state, align 4, !dbg !1045
  store i32 %611, i32* %s__state, align 4, !dbg !1046
  %612 = load i32, i32* %new_state, align 4, !dbg !1047
  store i32 %612, i32* %s__state, align 4, !dbg !1048
  br label %613, !dbg !1049

; <label>:613                                     ; preds = %609, %605
  br label %614, !dbg !1050

; <label>:614                                     ; preds = %613, %602
  br label %615, !dbg !1051

; <label>:615                                     ; preds = %614, %590
  br label %616, !dbg !1052

; <label>:616                                     ; preds = %615, %587
  store i32 0, i32* %skip, align 4, !dbg !1053
  br label %61, !dbg !215
                                                  ; No predecessors!
  br label %618, !dbg !1054

; <label>:618                                     ; preds = %617, %600, %549, %548, %531, %510, %506, %487, %475, %454, %447, %439, %430, %421, %412, %401, %356, %300, %281, %270, %257, %244, %237, %231, %227
  %619 = load i32, i32* %s__in_handshake, align 4, !dbg !1055
  %620 = add nsw i32 %619, -1, !dbg !1055
  store i32 %620, i32* %s__in_handshake, align 4, !dbg !1055
  %621 = load i32, i32* %cb, align 4, !dbg !1056
  %622 = icmp ne i32 %621, 0, !dbg !1058
  br i1 %622, label %623, label %624, !dbg !1059

; <label>:623                                     ; preds = %618
  br label %624, !dbg !1060

; <label>:624                                     ; preds = %623, %618
  %625 = load i32, i32* %ret, align 4, !dbg !1062
  store i32 %625, i32* %1, !dbg !1063
  br label %627, !dbg !1063
...
; <label>:627                                     ; preds = %624, %219, %59
  %628 = load i32, i32* %1, !dbg !1065
  ret i32 %628, !dbg !1065
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @llvm.dbg.declare(metadata i32* %s, metadata !1066, metadata !19), !dbg !1067
  call void @llvm.dbg.declare(metadata i32* %tmp, metadata !1068, metadata !19), !dbg !1069
  store i32 8464, i32* %s, align 4, !dbg !1070
  %2 = load i32, i32* %s, align 4, !dbg !1073
  %3 = call i32 @ssl3_accept(i32 %2), !dbg !1074
  store i32 %3, i32* %tmp, align 4, !dbg !1075
  %4 = load i32, i32* %tmp, align 4, !dbg !1076
  ret i32 %4, !dbg !1077
}
...
!1 = !DIFile(filename: "../sv-comp-2016/c/ssh-simplified/s3_srvr_8_true-unreach-call.cil.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
!3 = !{!4}
...
!1018 = !DILocation(line: 644, column: 13, scope: !1019)
!1019 = distinct !DILexicalBlock(scope: !1020, file: !7, line: 644, column: 13)
!1020 = distinct !DILexicalBlock(scope: !1015, file: !7, line: 643, column: 19)
!1021 = !DILocation(line: 644, column: 13, scope: !1020)
!1022 = !DILocation(line: 645, column: 17, scope: !1023)
!1023 = distinct !DILexicalBlock(scope: !1019, file: !7, line: 644, column: 23)
!1024 = !DILocation(line: 645, column: 15, scope: !1023)
!1025 = !DILocation(line: 646, column: 15, scope: !1026)
!1026 = distinct !DILexicalBlock(scope: !1023, file: !7, line: 646, column: 15)
!1027 = !DILocation(line: 646, column: 19, scope: !1026)
!1028 = !DILocation(line: 646, column: 15, scope: !1023)
!1029 = !DILocation(line: 647, column: 13, scope: !1030)
!1030 = distinct !DILexicalBlock(scope: !1026, file: !7, line: 646, column: 25)
!1031 = !DILocation(line: 649, column: 9, scope: !1023)
!1032 = !DILocation(line: 654, column: 13, scope: !1033)
!1033 = distinct !DILexicalBlock(scope: !1020, file: !7, line: 654, column: 13)
!1034 = !DILocation(line: 654, column: 16, scope: !1033)
!1035 = !DILocation(line: 654, column: 13, scope: !1020)
!1036 = !DILocation(line: 655, column: 15, scope: !1037)
!1037 = distinct !DILexicalBlock(scope: !1038, file: !7, line: 655, column: 15)
!1038 = distinct !DILexicalBlock(scope: !1033, file: !7, line: 654, column: 22)
!1039 = !DILocation(line: 655, column: 27, scope: !1037)
!1040 = !DILocation(line: 655, column: 24, scope: !1037)
!1041 = !DILocation(line: 655, column: 15, scope: !1038)
!1042 = !DILocation(line: 656, column: 25, scope: !1043)
!1043 = distinct !DILexicalBlock(scope: !1037, file: !7, line: 655, column: 34)
!1044 = !DILocation(line: 656, column: 23, scope: !1043)
!1045 = !DILocation(line: 657, column: 24, scope: !1043)
!1046 = !DILocation(line: 657, column: 22, scope: !1043)
!1047 = !DILocation(line: 658, column: 24, scope: !1043)
!1048 = !DILocation(line: 658, column: 22, scope: !1043)
!1049 = !DILocation(line: 659, column: 11, scope: !1043)
!1050 = !DILocation(line: 660, column: 9, scope: !1038)
!1051 = !DILocation(line: 661, column: 7, scope: !1020)
!1052 = !DILocation(line: 662, column: 5, scope: !1016)
!1053 = !DILocation(line: 671, column: 10, scope: !219)
!1054 = !DILocation(line: 674, column: 3, scope: !216)
!1055 = !DILocation(line: 676, column: 19, scope: !168)
!1056 = !DILocation(line: 677, column: 7, scope: !1057)
!1057 = distinct !DILexicalBlock(scope: !168, file: !7, line: 677, column: 7)
!1058 = !DILocation(line: 677, column: 10, scope: !1057)
!1059 = !DILocation(line: 677, column: 7, scope: !168)
!1060 = !DILocation(line: 679, column: 3, scope: !1061)
!1061 = distinct !DILexicalBlock(scope: !1057, file: !7, line: 677, column: 16)
!1062 = !DILocation(line: 682, column: 11, scope: !168)
!1063 = !DILocation(line: 682, column: 3, scope: !168)
!1064 = !DILocation(line: 683, column: 10, scope: !168)
!1065 = !DILocation(line: 686, column: 1, scope: !6)
!1066 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "s", scope: !11, file: !7, line: 688, type: !10)
!1067 = !DILocation(line: 688, column: 7, scope: !11)
!1068 = !DILocalVariable(tag: DW_TAG_auto_variable, name: "tmp", scope: !11, file: !7, line: 689, type: !10)
!1069 = !DILocation(line: 689, column: 7, scope: !11)
!1070 = !DILocation(line: 693, column: 5, scope: !1071)
!1071 = distinct !DILexicalBlock(scope: !1072, file: !7, line: 692, column: 3)
!1072 = distinct !DILexicalBlock(scope: !11, file: !7, line: 691, column: 3)
!1073 = !DILocation(line: 694, column: 21, scope: !1071)
!1074 = !DILocation(line: 694, column: 9, scope: !1071)
!1075 = !DILocation(line: 694, column: 7, scope: !1071)
!1076 = !DILocation(line: 696, column: 11, scope: !1072)
!1077 = !DILocation(line: 696, column: 3, scope: !1072)
