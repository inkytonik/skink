...
; <label>:763                                     ; preds = %759
  br label %995, !dbg !2317

; <label>:764                                     ; preds = %759
  br label %765

; <label>:765                                     ; preds = %764
  %766 = load i32, i32* %ret, align 4, !dbg !2319
  %767 = icmp sle i32 %766, 0, !dbg !2321
  br i1 %767, label %768, label %769, !dbg !2322

; <label>:768                                     ; preds = %765
  br label %983, !dbg !2323

; <label>:769                                     ; preds = %765
  br label %770

; <label>:770                                     ; preds = %769
  %771 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2325
  %772 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %771, i32 0, i32 23, !dbg !2327
  %773 = load i32, i32* %772, align 4, !dbg !2327
  %774 = icmp ne i32 %773, 0, !dbg !2325
  br i1 %774, label %775, label %778, !dbg !2328

; <label>:775                                     ; preds = %770
  %776 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2329
  %777 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %776, i32 0, i32 13, !dbg !2331
  store i32 3, i32* %777, align 4, !dbg !2332
  br label %781, !dbg !2333

; <label>:778                                     ; preds = %770
  %779 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2334
  %780 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %779, i32 0, i32 13, !dbg !2336
  store i32 8656, i32* %780, align 4, !dbg !2337
  br label %781

; <label>:781                                     ; preds = %778, %775
  %782 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2338
  %783 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %782, i32 0, i32 16, !dbg !2339
  store i32 0, i32* %783, align 4, !dbg !2340
  br label %894, !dbg !2341

; <label>:784                                     ; preds = %246
  br label %785, !dbg !2341

; <label>:785                                     ; preds = %784, %252
  %786 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2342
  %787 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %786, i32 0, i32 21, !dbg !2343
  %788 = load %struct.ssl3_state_st*, %struct.ssl3_state_st** %787, align 8, !dbg !2343
  %789 = getelementptr inbounds %struct.ssl3_state_st, %struct.ssl3_state_st* %788, i32 0, i32 32, !dbg !2344
  %790 = getelementptr inbounds %struct.__anonstruct_tmp_39, %struct.__anonstruct_tmp_39* %789, i32 0, i32 7, !dbg !2345
  %791 = load %struct.ssl_cipher_st*, %struct.ssl_cipher_st** %790, align 8, !dbg !2345
  %792 = load %struct.ssl_st*, %struct.ssl_st** %2, align 8, !dbg !2346
  %793 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %792, i32 0, i32 37, !dbg !2347
  %794 = load %struct.ssl_session_st*, %struct.ssl_session_st** %793, align 8, !dbg !2347
  %795 = getelementptr inbounds %struct.ssl_session_st, %struct.ssl_session_st* %794, i32 0, i32 17, !dbg !2348
  store %struct.ssl_cipher_st* %791, %struct.ssl_cipher_st** %795, align 8, !dbg !2349
  %796 = load i32, i32* %tmp___9, align 4, !dbg !2350
  %797 = icmp ne i32 %796, 0, !dbg !2350
  br i1 %797, label %799, label %798, !dbg !2352

; <label>:798                                     ; preds = %785
  store i32 -1, i32* %ret, align 4, !dbg !2353
  br label %983, !dbg !2355

; <label>:799                                     ; preds = %785
  br label %800

; <label>:800                                     ; preds = %799
  %801 = call i32 @__VERIFIER_nondet_int(), !dbg !2356
  store i32 %801, i32* %ret, align 4, !dbg !2357
  %802 = load i32, i32* %blastFlag, align 4, !dbg !2358
  %803 = icmp eq i32 %802, 2, !dbg !2360
  br i1 %803, label %804, label %805, !dbg !2361

; <label>:804                                     ; preds = %800
  store i32 3, i32* %blastFlag, align 4, !dbg !2362
  br label %816, !dbg !2364

; <label>:805                                     ; preds = %800
  %806 = load i32, i32* %blastFlag, align 4, !dbg !2365
  %807 = icmp eq i32 %806, 4, !dbg !2368
  br i1 %807, label %808, label %809, !dbg !2369

; <label>:808                                     ; preds = %805
  store i32 5, i32* %blastFlag, align 4, !dbg !2370
  br label %815, !dbg !2372

; <label>:809                                     ; preds = %805
  %810 = load i32, i32* %blastFlag, align 4, !dbg !2373
  %811 = icmp eq i32 %810, 7, !dbg !2376
  br i1 %811, label %812, label %813, !dbg !2377

; <label>:812                                     ; preds = %809
  store i32 8, i32* %blastFlag, align 4, !dbg !2378
  br label %814, !dbg !2380

; <label>:813                                     ; preds = %809
  br label %814

; <label>:814                                     ; preds = %813, %812
  br label %815

; <label>:815                                     ; preds = %814, %808
  br label %816
...
; <label>:894                                     ; preds = %893, %862, %830, %781, %753, %741, %733, %700, %673, %665, %564, %453, %425, %397, %379, %369, %359
  br label %895
...
; <label>:983                                     ; preds = %982, %950, %892, %891, %841, %828, %819, %798, %768, %751, %739, %726, %714, %694, %671, %643, %553, %450, %412, %395, %367, %337, %325, %315, %310
...
!1 = !DIFile(filename: "../sv-comp-2016/c/ssh/s3_srvr.blast.07_false-unreach-call.i.cil.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
...
!2317 = !DILocation(line: 1557, column: 79, scope: !2318)
!2318 = distinct !DILexicalBlock(scope: !2314, file: !1, line: 1556, column: 97)
!2319 = !DILocation(line: 1561, column: 81, scope: !2320)
!2320 = distinct !DILexicalBlock(scope: !1761, file: !1, line: 1561, column: 81)
!2321 = !DILocation(line: 1561, column: 85, scope: !2320)
!2322 = !DILocation(line: 1561, column: 81, scope: !1761)
!2323 = !DILocation(line: 1562, column: 79, scope: !2324)
!2324 = distinct !DILexicalBlock(scope: !2320, file: !1, line: 1561, column: 91)
!2325 = !DILocation(line: 1566, column: 81, scope: !2326)
!2326 = distinct !DILexicalBlock(scope: !1761, file: !1, line: 1566, column: 81)
!2327 = !DILocation(line: 1566, column: 84, scope: !2326)
!2328 = !DILocation(line: 1566, column: 81, scope: !1761)
!2329 = !DILocation(line: 1567, column: 79, scope: !2330)
!2330 = distinct !DILexicalBlock(scope: !2326, file: !1, line: 1566, column: 89)
!2331 = !DILocation(line: 1567, column: 82, scope: !2330)
!2332 = !DILocation(line: 1567, column: 88, scope: !2330)
!2333 = !DILocation(line: 1568, column: 77, scope: !2330)
!2334 = !DILocation(line: 1569, column: 79, scope: !2335)
!2335 = distinct !DILexicalBlock(scope: !2326, file: !1, line: 1568, column: 84)
!2336 = !DILocation(line: 1569, column: 82, scope: !2335)
!2337 = !DILocation(line: 1569, column: 88, scope: !2335)
!2338 = !DILocation(line: 1571, column: 77, scope: !1761)
!2339 = !DILocation(line: 1571, column: 80, scope: !1761)
!2340 = !DILocation(line: 1571, column: 89, scope: !1761)
!2341 = !DILocation(line: 1572, column: 77, scope: !1761)
!2342 = !DILocation(line: 1575, column: 101, scope: !1761)
!2343 = !DILocation(line: 1575, column: 104, scope: !1761)
!2344 = !DILocation(line: 1575, column: 109, scope: !1761)
!2345 = !DILocation(line: 1575, column: 113, scope: !1761)
!2346 = !DILocation(line: 1575, column: 78, scope: !1761)
!2347 = !DILocation(line: 1575, column: 81, scope: !1761)
!2348 = !DILocation(line: 1575, column: 91, scope: !1761)
!2349 = !DILocation(line: 1575, column: 98, scope: !1761)
!2350 = !DILocation(line: 1576, column: 83, scope: !2351)
!2351 = distinct !DILexicalBlock(scope: !1761, file: !1, line: 1576, column: 81)
!2352 = !DILocation(line: 1576, column: 81, scope: !1761)
!2353 = !DILocation(line: 1577, column: 83, scope: !2354)
!2354 = distinct !DILexicalBlock(scope: !2351, file: !1, line: 1576, column: 92)
!2355 = !DILocation(line: 1578, column: 79, scope: !2354)
!2356 = !DILocation(line: 1582, column: 83, scope: !1761)
!2357 = !DILocation(line: 1582, column: 81, scope: !1761)
!2358 = !DILocation(line: 1583, column: 81, scope: !2359)
!2359 = distinct !DILexicalBlock(scope: !1761, file: !1, line: 1583, column: 81)
!2360 = !DILocation(line: 1583, column: 91, scope: !2359)
!2361 = !DILocation(line: 1583, column: 81, scope: !1761)
!2362 = !DILocation(line: 1584, column: 89, scope: !2363)
!2363 = distinct !DILexicalBlock(scope: !2359, file: !1, line: 1583, column: 97)
!2364 = !DILocation(line: 1585, column: 77, scope: !2363)
!2365 = !DILocation(line: 1586, column: 83, scope: !2366)
!2366 = distinct !DILexicalBlock(scope: !2367, file: !1, line: 1586, column: 83)
!2367 = distinct !DILexicalBlock(scope: !2359, file: !1, line: 1585, column: 84)
!2368 = !DILocation(line: 1586, column: 93, scope: !2366)
!2369 = !DILocation(line: 1586, column: 83, scope: !2367)
!2370 = !DILocation(line: 1587, column: 91, scope: !2371)
!2371 = distinct !DILexicalBlock(scope: !2366, file: !1, line: 1586, column: 99)
!2372 = !DILocation(line: 1588, column: 79, scope: !2371)
!2373 = !DILocation(line: 1589, column: 85, scope: !2374)
!2374 = distinct !DILexicalBlock(scope: !2375, file: !1, line: 1589, column: 85)
!2375 = distinct !DILexicalBlock(scope: !2366, file: !1, line: 1588, column: 86)
!2376 = !DILocation(line: 1589, column: 95, scope: !2374)
!2377 = !DILocation(line: 1589, column: 85, scope: !2375)
!2378 = !DILocation(line: 1590, column: 93, scope: !2379)
!2379 = distinct !DILexicalBlock(scope: !2374, file: !1, line: 1589, column: 101)
!2380 = !DILocation(line: 1591, column: 81, scope: !2379)
