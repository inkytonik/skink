...
; <label>:384                                     ; preds = %379
  %385 = load i32, i32* %blastFlag, align 4, !dbg !1874
  %386 = icmp eq i32 %385, 4, !dbg !1877
  br i1 %386, label %387, label %388, !dbg !1878

; <label>:387                                     ; preds = %384
  store i32 5, i32* %blastFlag, align 4, !dbg !1879
  br label %389, !dbg !1881
...
; <label>:787                                     ; preds = %786, %722, %702, %681, %626, %559, %549, %511, %499, %473, %460, %434, %406, %377, %335
  br label %788
...
; <label>:874                                     ; preds = %873, %841, %785, %784, %716, %689, %632, %624, %619, %573, %557, %521, %509, %483, %471, %458, %449, %431, %393, %359, %333, %328, %318, %313, %297
...
!1 = !DIFile(filename: "../sv-comp-2016/c/ssh/s3_clnt.blast.03_false-unreach-call.i.cil.c", directory: "/Users/franck/development/perentiemq")
!2 = !{}
...
!1874 = !DILocation(line: 1317, column: 79, scope: !1875)
!1875 = distinct !DILexicalBlock(scope: !1876, file: !1, line: 1317, column: 79)
!1876 = distinct !DILexicalBlock(scope: !1868, file: !1, line: 1316, column: 80)
!1877 = !DILocation(line: 1317, column: 89, scope: !1875)
!1878 = !DILocation(line: 1317, column: 79, scope: !1876)
!1879 = !DILocation(line: 1318, column: 87, scope: !1880)
!1880 = distinct !DILexicalBlock(scope: !1875, file: !1, line: 1317, column: 95)
!1881 = !DILocation(line: 1319, column: 75, scope: !1880)
