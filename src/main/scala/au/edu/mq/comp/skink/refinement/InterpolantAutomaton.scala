...
trait AddBackEdges extends Core with Resources {
     ...
     * @note
     */
    def computeSafeBackEdges(function : Verifiable, choices : Seq[Choice], preds : Seq[TypedTerm[BoolTerm, Term]]) = {
...
case class Interpolant(function : Verifiable, choices : Seq[Choice], fromEnd : Boolean) extends AddBackEdges with Commands {
