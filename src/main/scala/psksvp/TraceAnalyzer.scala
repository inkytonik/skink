...
case class TraceAnalyzer(function : IRFunction, choices : Seq[Int]) extends Commands
    ...
    //////////////////////////////////////////////////
    def automatonWithBackEdges(tracePredicates : Seq[PredicateTerm])(implicit solver : SMTSolver) : NFA[Int, Int] =
        {
            //////////////////////////////////////////
            ...
            lazy val backEdges : Seq[LabDiEdge[Int, Int]] =
                {
                    ...
                    val newBackEdges = for (
                        (i, j) <- repetitionsPairs; if checkTransitionPost(
                            fromSource = j,
                            toSink = i + 1,
                            exitChoice = choices(i))
                    ) yield {
