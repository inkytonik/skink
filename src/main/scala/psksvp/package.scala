...
package object psksvp {
     ...
     * @return
     */
    def satisfiableCheck(term : PredicateTerm)(implicit solver : SMTSolver) : SatResponses =
        {
            push()
     ...
     * @return
     */
    def validityCheck(term : PredicateTerm)(implicit solver : SMTSolver) : Boolean = UnSat() == satisfiableCheck(!term)
...
/***
    ...
    * @return
    */
    def equivalence(f1 : PredicateTerm, f2 : PredicateTerm)(implicit solver : SMTSolver) : Boolean = validityCheck(f1 === f2)
     ...
     * @return
     */
    def subsetCheck(predicate : PredicateTerm, withSuperSet : PredicateTerm)(implicit solver : SMTSolver) : Boolean =
        {
     ...
     */
    def checkPost(p : PredicateTerm, e : PredicateTerm, q : PredicateTerm)(implicit solver : SMTSolver) : Boolean = subsetCheck(p & e, q)
