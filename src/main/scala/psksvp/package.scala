...
package object psksvp
{
  ...
  type BoolTypedTerm = TypedTerm[BoolTerm, Term]
  ...
  /**
    ...
    * @return
    */
  def satisfiableCheck(term : BoolTypedTerm)
  ...
  /**
    ...
    * @return
    */
  def validityCheck(term : BoolTypedTerm)
  ...
  /***
    ...
    * @return
    */
  def equivalence(f1:BoolTypedTerm, f2:BoolTypedTerm)
                 (implicit solver:SMTSolver):Boolean = validityCheck(f1 === f2)


  /**
    * check if predicate p is included in q
    * @param predicate
    * @param withSuperSet
    * @param solver
    * @return
    */
  def included(predicate:BoolTypedTerm, withSuperSet:BoolTypedTerm)
  ...
  /**
    ...
    */
  def checkPost(p:BoolTypedTerm, e:BoolTypedTerm, q:BoolTypedTerm)
               (implicit solver:SMTSolver):Boolean = included(p & e, q)
  ...
  /**
    ...
    * @return
    */
  def impiles(a:BoolTypedTerm,
              b:BoolTypedTerm):BoolTypedTerm = !(a) | b
  ...
  /**
    ...
    * @return
    */
  def toCNF(s:List[List[BoolTypedTerm]]):BoolTypedTerm = s match
  {
  ...
  def toDNF(s:List[List[BoolTypedTerm]]):BoolTypedTerm = s match
  {
    case Nil       => sys.error("psksvp.CNF, Nil list was passed")
    case l :: Nil  => l.reduce(_ & _)
